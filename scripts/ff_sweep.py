...
def _compute_econ_metrics_for_eval(
    ...
    out = evaluate_goodness_strategy(
        ...
        short_borrow_bps=float(cfg.get("econ_short_borrow_bps", 0.0)),
        max_abs_exposure=float(cfg.get("econ_max_abs_exposure", 1.0)),
...
def _run_ff_trial(
    ...
    model = GCNEncoder(
        ...
        rgcn_num_relations=max(2, int(cfg.get("encoder_rgcn_num_relations", 8))),
...
def main() -> int:
    ...
    base = {
        ...
        "econ_short_borrow_bps": float(sweep_cfg.get("econ_short_borrow_bps", 0.0)),
        "econ_max_abs_exposure": float(sweep_cfg.get("econ_max_abs_exposure", 1.0)),
